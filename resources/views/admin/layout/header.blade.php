<nav id="header" class="bg-white space-y-0 fixed w-full z-10 top-0 shadow">
    ...
    <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
        ...
        <div class="w-1/2 pl-2 md:pl-0">
            <a class="text-gray-900 flex items-center text-base xl:text-xl no-underline hover:no-underline font-bold"
                href="#">
                <img src="/image/logo-HB.png" class="" alt="" width="50" height="50"> SMK Harapan Bangsa
                Depok
            </a>
        </div>
                ...
                <div class="relative text-sm">
                    <button id="userButton" class="flex items-center focus:outline-none mr-3">
                        <img class="w-8 h-8 rounded-full mr-4" src="http://i.pravatar.cc/300" alt="Avatar of User"> <span
                            class="hidden md:inline-block">Hi, {{ Auth::user()->name }} </span>
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20"
            ...
            <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                ...
                <li class="mr-6 my-2 md:my-0">
                    <a href="/admin/guru"
                        class="{{ request()->is('admin/guru*') ? 'border-pink-500' : '' }} block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-pink-500">
                        <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Guru</span>
                    </a>
                </li>
                <li class="mr-6 my-2 md:my-0">
                    <a href="/admin/calonsiswa"
                        class="{{ request()->is('admin/calonsiswa*') ? 'border-purple-500' : '' }} block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-purple-500">
                        <i class="fa fa-envelope fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Calon Siswa</span>
                    </a>
                </li>
                <li class="mr-6 my-2 md:my-0">
                    <a href="/admin/prestasi"
                        class="{{ request()->is('admin/prestasi*') ? 'border-green-500' : '' }} block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-green-500">
                        <i class="fas fa-chart-area fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Prestasi</span>
                    </a>
                </li>
                <li class="mr-6 my-2 md:my-0">
                    <a href="/admin/review"
                        class="{{ request()->is('admin/review*') ? 'border-red-500' : '' }} block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-red-500">
                        <i class="fa fa-wallet fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Review</span>
                    </a>
                </li>
                <li class="mr-6 my-2 md:my-0">
                    <a href="/admin/affiliate"
                        class="{{ request()->is('admin/affiliate*') ? 'border-yellow-500' : '' }} block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-yellow-500">
                        <i class="fa fa-wallet fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Affiliate</span>
                    </a>
                </li>
                <li class="mr-6 my-2 md:my-0">
                    <a href="/admin/ekskul"
                        class="{{ request()->is('admin/ekskul*') ? 'border-green-500' : '' }} block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-green-500">
                        <i class="fa fa-wallet fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Ekskul</span>
                    </a>
                </li>
            </ul>
