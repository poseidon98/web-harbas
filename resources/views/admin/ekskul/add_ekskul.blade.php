    ...
    <div class="container w-full mx-auto pt-20">
        ...
        <div class="bg-gray-100 p-0 sm:p-12">
            <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
                <h1 class="text-2xl font-bold mb-8">Tambah Data Ekskul</h1>
                <form method="POST" action="/admin/ekskul/add/proses" enctype="multipart/form-data" id="form">
                    @csrf
                    <div class="relative z-0 w-full mb-5">
                        <input type="text" name="nama_logo" placeholder=" " required
                    ...
                    <input id="button" type="submit" value="Tambah Data"
